...
public class PriorityQueueMaxHeap<T extends Comparable<? super T>> {
    ...
    public PriorityQueueMaxHeap(int initialCapacity) {
        backingArray = (T[]) new Comparable[Math.max(2, initialCapacity)];
    }

    public PriorityQueueMaxHeap(ArrayList<T> data) {
        if (data == null) {
