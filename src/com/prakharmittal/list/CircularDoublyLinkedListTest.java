...
public class CircularDoublyLinkedListTest {
    ...
    public void t03_AddAtIndexSizeZero() {
        ...
        CircularDoublyLinkedList.Node<String> cur = list.getHead();
        assertNotNull(cur);
    ...
    public void t04_AddAtIndexSizeOneIndexZero() {
        ...
        cur = cur.getPrevious();
        assertNotNull(cur);
        assertEquals(list.getHead().getPrevious(), cur);
    }
    ...
    public void t48_EqualsEmpty() {
        CircularDoublyLinkedList<String> list2 = new CircularDoublyLinkedList<>();
