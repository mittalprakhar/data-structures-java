...
public class CircularSinglyLinkedList<T> implements Iterable<T> {
    ...
    public void addAtIndex(int index, T data) {
        ...
        if (isEmpty()) {
            ...
            head.setNext(new Node<T>(head.getData(), head.getNext()));
            head.setData(data);
        } else if (index == size) {
            head.setNext(new Node<T>(head.getData(), head.getNext()));
            head.setData(data);
    ...
    public T removeLastOccurrence(T data) {
        ...
        for (Node<T> current = head; current.getNext() != head; current = current.getNext()) {
    ...
    public boolean equals(Object o) {
        if (this == o) {
            return true;
        } else if (o instanceof CircularSinglyLinkedList<?>) {
            CircularSinglyLinkedList<?> other = (CircularSinglyLinkedList<?>) o;
        }
        return false;
    }
    ...
    private class CSLIterator implements Iterator<T> {
